 ...
 */
public class EntireOrderRoomVideoListAdapter extends BaseQuickAdapter<RoomListBean.RowsBean, BaseViewHolder> {

    public EntireOrderRoomVideoListAdapter(@Nullable List<RoomListBean.RowsBean> data) {
    ...
    protected void convert(BaseViewHolder helper, RoomListBean.RowsBean item) {
        ...
        helper.setText(R.id.tv_time, "就诊时间:" + item.getReserveDate() + " " + DocConstant.time[Integer.parseInt(item.getReserveTime())]);
