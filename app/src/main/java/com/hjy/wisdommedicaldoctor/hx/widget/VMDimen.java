...
public class VMDimen {
    ...
    public static Point getScreenSize() {
        WindowManager wm = (WindowManager) ConfigUtils.getAppCtx()
    ...
    public static int getStatusBarHeight() {
        Resources res = ConfigUtils.getAppCtx().getResources();
    ...
    public static int getToolbarHeight() {
        ...
        if (ConfigUtils.getAppCtx()
            .getTheme()
            .resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            height = TypedValue.complexToDimensionPixelSize(tv.data, ConfigUtils.getAppCtx()
                .getResources()
                .getDisplayMetrics());
        }
    ...
    private static boolean hasNavigationBar() {
        ...
        Resources rs = ConfigUtils.getAppCtx().getResources();
