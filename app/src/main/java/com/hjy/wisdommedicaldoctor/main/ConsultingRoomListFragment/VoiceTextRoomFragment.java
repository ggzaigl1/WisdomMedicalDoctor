...
import com.hjy.wisdommedicaldoctor.adapter.EntireOrderVoiceRoomListAdapter;
 ...
 */
public class VoiceTextRoomFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    int mPageNo = 1;
    private EntireOrderVoiceRoomListAdapter mAdapter;
    ...
    private void initRv() {
        ...
        mAdapter = new EntireOrderVoiceRoomListAdapter(new ArrayList<>());
    ...
    public void callVoice(AppCompatActivity act, String toChatUsername) {
