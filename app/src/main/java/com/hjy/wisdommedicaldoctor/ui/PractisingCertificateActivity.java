 ...
 * 手持身份证
 */
public class PractisingCertificateActivity extends AppCompatActivity implements IBaseActivity, View.OnClickListener {
    ...
    @OnClick({R.id.bt_next, R.id.Ll_practising})
    @Override
