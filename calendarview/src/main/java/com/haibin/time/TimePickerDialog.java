...
import com.haibin.HapticFeedbackController;
import com.haibin.Utils;
 ...
 */
public class TimePickerDialog extends CommonDialog implements RadialPickerLayout.OnValueSelectedListener {
...
//        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, int hourOfDayEnd, int minuteEnd);
    ...
    protected int initLayoutId() {
        return R.layout.range_time_picker_dialog;
    }
    ...
    public void convertView(ViewHolder holder, CommonDialog dialog) {
        ...
        mHourView = holder.getView(R.id.hours);
        mHourView.setOnKeyListener(keyboardListener);
        mHourSpaceView = holder.getView(R.id.hour_space);
        mMinuteSpaceView = (TextView) holder.getView(R.id.minutes_space);
        mMinuteView = (TextView) holder.getView(R.id.minutes);
        ...
        mTimePicker = holder.getView(R.id.time_picker);
...
//        }
        ...
        mOkButton = holder.getView(R.id.ok);
        ...
        mCancelButton = holder.getView(R.id.cancel);
        ...
        if (mIs24HourMode) {
            ...
            TextView separatorView = holder.getView(R.id.separator);
